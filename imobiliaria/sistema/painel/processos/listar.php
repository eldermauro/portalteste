...
if($nivel_usuario == 'Corretor'){
	$query = $pdo->query("SELECT * FROM processos where corretor = '$id_usuario' ORDER BY id desc");
}else{
	$query = $pdo->query("SELECT * FROM processos ORDER BY id desc");
}
...
<script type="text/javascript">
	...
	function editar(id, produto, produtor, avaliacao, local, bruto, liquido, reprovado, valor, pagar, data_cad, corretor){
