...
<div class="modal fade" id="modalForm" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static">
    ...
    <li class="nav-item">
      <a class="nav-link" id="despolpa-tab" data-toggle="tab" href="#despolpa" role="tab" aria-controls="despolpa" aria-selected="false">Trituração</a>
    </li>
    <li class="nav-item">
					...
					<div class="tab-pane fade" id="despolpa" role="tabpanel" aria-labelledby="despolpa-tab"><!--fim começo despolpa-->
													...
													<div class="col-md-3">
															...
															<div class="col-md-3">						
																...
																<div class="col-md-3">
																<div class="form-group">
																	<label>Perda na trituração</label>
...
<div class="modal fade" id="modalMostrar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" >
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title" id=""><span id=""> </span> <small><span class="ml-4">(processo manteiga: <span id="materia_mostrar"> </span>) </span> </small></h4>
				...
				<div class="row" style="border-bottom: 1px solid #cac7c7;">
					...
					<div class="row" style="border-bottom: 1px solid #cac7c7;">
						...
						<div class="row" style="border-bottom: 1px solid #cac7c7;">
					<span><b>Trituração </b></span><br></div>
					...
					<span><b>Resultado </b></span><br>
						<div class="col-md-6">							
							<span><b>Quantidade da trituração: </b></span>
					...
					<div class="row" style="border-bottom: 1px solid #cac7c7;">
						<div class="col-md-6">							
							<span><b>Perda na trituração: </b></span>
