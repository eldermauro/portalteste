...
$pag = 'compradores';  //clientes

 ?>

 <button onclick="inserir()" type="button" class="btn btn-info btn-flat btn-pri"><i class="fa fa-plus" aria-hidden="true"></i> Novo Cliente</button>
				...
				<div class="modal-body">
					...
					<div class="col-md-3">						
						...
						<div class="col-md-4">						
							<div class="form-group"> 
								...
								<input type="date" class="form-control" name="data_nasc" id="data_nasc" value="<qq?php echo date('Y-m-d') ?>"> 
							</div>						
						</div>-->
				   ...
				   <span type="submit" id="btn" class="btn btn-success btn-custom mt-2 justify-content-start"  style="right:30px; position:relative; margin-top:21px;"><svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
					...
					<div class="col-md-2">
						...
						<br>
						<h4>Endereço Pessoa Jurídica </h4>
						<br>
						...
						<div class="form-group"> 
						<label>CEP</label> 
						<input type="text" class="form-control" name="cepj" id="cepj" placeholder=""> 	
						</div>
					</div>		
					...
					<div class="col-md-3">
						<div class="form-group"> 
							<label>Endereço</label> 
							<input type="text" class="form-control" name="logradouroj" id="logradouroj" placeholder="Rua X Número 20 Bairro X"> 
						</div>
					</div>
					...
					<div class="col-md-2">
						<div class="form-group"> 
							<label>UF</label> 
							<input type="text" class="form-control" name="ufj" id="ufj" placeholder=""> 
						</div>
					</div>	
					...
					<div class="col-md-2">
						<div class="form-group"> 
							<label>Cidade</label> 
							<input type="text" class="form-control" name="cidadej" id="cidadej" placeholder=""> 
						</div>
					</div>	
		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<div class="modal-body">			
					...
					<div class="row" style="border-bottom: 1px solid #cac7c7;">
					<h4>Endereço Pessoa Física</h4><br>
						<div class="col-md-6">							
							<span><b>CEP: </b></span>
					...
					<div class="row" style="border-bottom: 1px solid #cac7c7;">
					<h4>Endereço Pessoa Jurídica</h4><br>
						<div class="col-md-6">							
							<span><b>CEP: </b></span>
							<span id="cepj_mostrar"></span>							
						</div>


						<div class="col-md-6">							
							<span><b>Endereço: </b></span>
							<span id="logradouroj_mostrar"></span>							
						</div>
					...
					<div class="row" style="border-bottom: 1px solid #cac7c7;">
						<div class="col-md-4">							
							<span><b>UF: </b></span>
							<span id="ufj_mostrar"></span>							
						</div>


						<div class="col-md-4">							
							<span><b>Cidade: </b></span>
							<span id="cidadej_mostrar"></span>							
						</div>
