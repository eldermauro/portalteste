					...
					<div class="row">
						...
						<div class="col-md-4">						
							<div class="form-group"> 
								...
								<select class="form-control sel2" name="comprador" id="comprador" style="width:100%;"> 

									<option value="">Selecione um Comprador</option>

									<?php 
									$query = $pdo->query("SELECT * FROM compradores order by nome asc");
						...
						<div class="col-md-4">						
							<div class="form-group"> 
								...
								<select class="form-control sel2" name="locatario" id="locatario" style="width:100%;"> 

									<option value="">Selecione um Locatário</option>

									<?php 
									$query = $pdo->query("SELECT * FROM locatarios order by nome asc");
									$res = $query->fetchAll(PDO::FETCH_ASSOC);
									for($i=0; $i < @count($res); $i++){
										foreach ($res[$i] as $key => $value){}
